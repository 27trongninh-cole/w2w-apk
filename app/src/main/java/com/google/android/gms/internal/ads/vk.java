...
public final class vk {
    ...
    public vk(i5.c cVar, androidx.lifecycle.z zVar) {
        ...
        for (int i7 = 0; i7 < 3; i7++) {
            ...
            if (i7 == 0) {
                aVarE.f(8);   // packet type (1 byte)
                aVarE.f(24); aVarE.f(24);  // chữ "vorbis" (6 byte = 48 bit) - THIẾU Ở BẢN GỐC, gây đọc sai ID header âm thầm
                this.f8888c = new a6.a(this, aVarE);
            } else if (i7 == 1) {
                aVarE.h(dVarB.f11789d[1] * 8, 2);
                aVarE.f(8);   // packet type (1 byte)
                aVarE.f(24); aVarE.f(24);  // chữ "vorbis" (6 byte = 48 bit) - THIẾU Ở BẢN GỐC, gây lỗi "code book sync pattern"
