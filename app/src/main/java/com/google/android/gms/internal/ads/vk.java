...
public final class vk {
    ...
    // Bo doc goi (packet) header dung chung cho 2 header packet (id + setup),
    ...
    public vk(i5.c cVar, androidx.lifecycle.z zVar) {
        ...
        // voi gia dinh ngam la setup header (chua toan bo codebook) nam gon trong DUY NHAT 1
        // Ogg page. Voi file WAV lon/chat luong cao, setup header (danh sach codebook) co the
        // vuot qua 1 page va trai dai qua nhieu page ke tiep, khien gia dinh do sai -> doc
        // trung du lieu bi cat cut/lech bit -> loi "code book sync pattern is not correct".
        //
        // Da xac nhan: dinh dang ogg do wenc() (mwem) sinh ra CHI CO 2 header packet (khong co
        // comment/vendor header o giua) -> packet 0 = identification, packet 1 = setup (chua
        // codebook). Fix: giu dung thu tu packet nhu cu, chi thay cach doc tu "1 page = 1
        // packet" bang bo doc co kha nang noi cac segment/page lien tiep lai thanh 1 packet
        // logic hoan chinh (giong cach WemConverter dang doc cac audio packet ben duoi), de xu
        // ly dung truong hop setup header trai dai qua nhieu page.
